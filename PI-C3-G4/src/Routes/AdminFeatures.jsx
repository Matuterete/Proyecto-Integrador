...
const AdminFeatures = () => {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const url = 'https://prothechnics.us.to:8080/features/find/all';
                const method = 'GET';
                const data = null;
                const headers = {}
    ...
    const handleInput = async (feature) => {
        ...
        Swal.fire({
            ...
            preConfirm: (newValue) => {
                ...
                setDataRequest({
                    ...dataRequest,
                    url: 'https://prothechnics.us.to:8080/features/update',
                    method: 'PUT',
                    data: {
                        id: feature.id,
                        title: newValue,
    ...
    const handleChangeSend = () => {
        ...
        if (inputValue != '' && selectedImage != null) {
            ...
            setDataRequest({
                ...dataRequest,
                url: 'https://prothechnics.us.to:8080/features/add',
                method: 'POST',
                data: {
                    id: '',
                    title: inputValue,
    ...
    const handleClickDelete = (key) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                setDataRequest({
                    ...dataRequest,
                    url: `https://prothechnics.us.to:8080/features/delete/id/${key}`,
                    method: 'DELETE',
                    data: {},
                    headers: {}
                })

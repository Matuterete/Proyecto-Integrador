...
const AdminPage = () => {
  ...
  return (
    <div className="bodyPage ">
          ...
          <div className="ButtonContainer">
            {!isMobile && (
              <>
                <button
                  className={
                    elementSelected == "productos"
                      ? "selected-item-border-green button button-sin-borde"
                      : "button button-sin-borde"
                  }
                  onClick={() => handleButton("productos")}
                >
                  Productos
                </button>
                <button
                  className={
                    elementSelected == "categorias"
                      ? "selected-item-border-green button button-sin-borde"
                      : "button button-sin-borde"
                  }
                  onClick={() => handleButton("categorias")}
                >
                  Categorías
                </button>
                <button
                  className={
                    elementSelected == "caracteristicas"
                      ? "selected-item-border-green button button-sin-borde"
                      : "button button-sin-borde"
                  }
                  onClick={() => handleButton("caracteristicas")}
                >
                  Características
                </button>
                {sessionData && sessionData.user.role === "SUPERADMIN" && (
                  <button
                    onClick={() => handleButton("usuarios")}
                    className={
                      elementSelected == "usuarios"
                        ? "selected-item-border-green button button-sin-borde"
                        : "button button-sin-borde"
                    }
                  >
      ...
      {!isMobile && (
        <>
          <div>{elementSelected === "productos" && <AdminProducts />}</div>
          <div>{elementSelected === "categorias" && <AdminCategories />}</div>
          <div>
            {elementSelected === "caracteristicas" && <AdminFeatures />}
          </div>
          <div>{elementSelected === "usuarios" && <AdminUsers />}</div>
        </>
      )}
    </div>
  );
